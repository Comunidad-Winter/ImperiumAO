...
'*****************************************************************
'frmQuestActual - ImperiumAO - v1.4.5 R5
'*****************************************************************
...
Call ClientTCP.Send_Data(Quest_End)
Unload Me
End Sub
...
lbQuestInfo(0).Caption = Locale_GUI_Frase(207) & ": " & General_Field_Read(2, Datos, "¬")
lbQuestInfo(1).Caption = Locale_GUI_Frase(206) & ": " & General_Field_Read(3, Datos, "¬")

Objetivos = Val(General_Field_Read(4, Datos, "¬"))

If Objetivos > 0 Then
    lbQuestInfo(2).Caption = Locale_GUI_Frase(208) & ": " & General_Field_Read(4, Datos, "¬")
