...
'*****************************************************************
'frmBancoObj - ImperiumAO - v1.4.5 R5
'*****************************************************************
...
Call Form_MouseMove(Button, Shift, x, y)
Call ClientTCP.Send_Data(Bank_End)
End Sub
...
Me.Picture = General_Load_Picture_From_Resource_Ex("boveda")
m_Number = 1
m_Interval = 30
...
If Index = 0 Then
    Image1(Index).Picture = General_Load_Picture_From_Resource_Ex("retirar-down")
    Image1(Index).Tag = "1"
ElseIf Index = 1 Then
    Image1(Index).Picture = General_Load_Picture_From_Resource_Ex("depositar-down")
    Image1(Index).Tag = "1"
End If
...
If Index = 0 Then
    If Image1(Index).Tag = "0" Then
        Image1(Index).Picture = General_Load_Picture_From_Resource_Ex("retirar-over")
        Image1(Index).Tag = "1"
    End If
ElseIf Index = 1 Then
    If Image1(Index).Tag = "0" Then
        Image1(Index).Picture = General_Load_Picture_From_Resource_Ex("depositar-over")
        Image1(Index).Tag = "1"
    End If
End If
...
Select Case Index
    Case 0
        ...
        Call ClientTCP.Send_Data(Get_Item_Bank, List1(0).ListIndex + 1 & "," & Cantidad.Text)
                
   Case 1
        LastIndex2 = List1(1).ListIndex
        Call ClientTCP.Send_Data(Insert_Item_Bank, List1(1).ListIndex + 1 & "," & Cantidad.Text)
...
Select Case Index
    Case 0
        ...
        Select Case UserBancoInventory(List1(0).ListIndex + 1).ObjType
            Case 2
                Label1(3).Caption = Locale_GUI_Frase(175) & ": " & UserBancoInventory(List1(0).ListIndex + 1).MinHIT & "/" & UserBancoInventory(List1(0).ListIndex + 1).MaxHIT & ". " & UserBancoInventory(List1(0).ListIndex + 1).ExtraStr
                Label1(3).Visible = True
            Case 3
                Label1(3).Caption = Locale_GUI_Frase(176) & ": " & UserBancoInventory(List1(0).ListIndex + 1).Def & ". " & UserBancoInventory(List1(0).ListIndex + 1).ExtraStr
                Label1(3).Visible = True
            Case Else
                If LenB(UserBancoInventory(List1(0).ListIndex + 1).ExtraStr) > 0 Then
                    Label1(3).Caption = UserBancoInventory(List1(0).ListIndex + 1).ExtraStr
                    Label1(3).Visible = True
                Else
        ...
        If UserBancoInventory(List1(0).ListIndex + 1).GrhIndex <> 0 Then
            Call frmMain.Engine.Grh_Render_To_Hdc(UserBancoInventory(List1(0).ListIndex + 1).GrhIndex, Picture1.hDC, 0, 0)
        Else
