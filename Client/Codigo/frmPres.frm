...
'If ticks = 1 Then
'    Me.Picture = LoadPicture(App.Path & "\Graficos\Presentacion")
'ElseIf ticks = 2 Then
    'Me.Picture = LoadPicture(App.Path & "\Graficos\datafull")
'ElseIf ticks = 2 Then
'    Me.Picture = LoadPicture(App.Path & "\Graficos\argentum")
'Else
FinPres = True
'End If
