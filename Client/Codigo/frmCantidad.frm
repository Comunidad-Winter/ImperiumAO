...
'*****************************************************************
'frmCantidad - ImperiumAO - v1.4.5 R5
'*****************************************************************
...
imgCerrar.Picture = General_Load_Skin_Picture_From_Resource_Ex("cerrarcantdown")
End Sub
...
If imgCerrar.Tag = "0" Then
    imgCerrar.Picture = General_Load_Skin_Picture_From_Resource_Ex("cerrarcantover")
    imgCerrar.Tag = "1"
End If
...
imgAceptar.Picture = General_Load_Skin_Picture_From_Resource_Ex("dejardown")
End Sub
...
If imgAceptar.Tag = "0" Then
    imgAceptar.Picture = General_Load_Skin_Picture_From_Resource_Ex("dejarover")
    imgAceptar.Tag = "1"
End If
...
imgTodo.Picture = General_Load_Skin_Picture_From_Resource_Ex("dejartododown")
End Sub

Private Sub imgTodo_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)

If imgTodo.Tag = "0" Then
    imgTodo.Picture = General_Load_Skin_Picture_From_Resource_Ex("dejartodoover")
    imgTodo.Tag = "1"
End If
...
If ItemElegido <> FLAGORO Then
    Call ClientTCP.Send_Data(Drop_Item, Byte_To_String(ItemElegido) & Long_To_String(UserInventory(ItemElegido).Amount))
Else
    Call ClientTCP.Send_Data(Drop_Item, Byte_To_String(ItemElegido) & Long_To_String(IIf(CurrentUser.UserGLD <= 100000, CurrentUser.UserGLD, 100000)))
End If
...
Me.Visible = False
Call ClientTCP.Send_Data(Drop_Item, Byte_To_String(ItemElegido) & Long_To_String(Val(txtCant.Text)))
txtCant.Text = "0"
