...
'*****************************************************************
'frmComerciar - ImperiumAO - v1.4.5 R5
'*****************************************************************
...
Command2.Picture = General_Load_Picture_From_Resource_Ex("salir-down")
Command2.Tag = "1"
End Sub
...
If Command2.Tag = "0" Then
    Command2.Picture = General_Load_Picture_From_Resource_Ex("salir-over")
    Command2.Tag = "1"
End If
...
Call Form_MouseMove(Button, Shift, x, y)
Call ClientTCP.Send_Data(Commerce_End)
End Sub
...
Me.Picture = General_Load_Picture_From_Resource_Ex("comercio")
m_Number = 1
m_Interval = 30
...
If Index = 0 Then
    Image1(Index).Picture = General_Load_Picture_From_Resource_Ex("comprar-down")
    Image1(Index).Tag = "1"
ElseIf Index = 1 Then
    Image1(Index).Picture = General_Load_Picture_From_Resource_Ex("vender-down")
    Image1(Index).Tag = "1"
End If
...
If Index = 0 Then
    If Image1(Index).Tag = "0" Then
        Image1(Index).Picture = General_Load_Picture_From_Resource_Ex("comprar-over")
        Image1(Index).Tag = "1"
    End If
ElseIf Index = 1 Then
    If Image1(Index).Tag = "0" Then
        Image1(Index).Picture = General_Load_Picture_From_Resource_Ex("vender-over")
        Image1(Index).Tag = "1"
    End If
End If
...
Select Case Index
    Case 0
        ...
        If CurrentUser.UserGLD >= NPCInventory(List1(0).ListIndex + 1).Valor * Val(Cantidad) Then
            Call ClientTCP.Send_Data(Sell_Item, Byte_To_String(CByte(List1(0).ListIndex + 1)) & Integer_To_String(Val(Cantidad.Text)))
        Else
            Call PrintToConsole(Locale_GUI_Frase(395), 2, 51, 223, 1, 1)
            Exit Sub
        End If
    Case 1
        LastIndex2 = List1(1).ListIndex
        Call ClientTCP.Send_Data(Buy_Item, Byte_To_String(CByte(List1(1).ListIndex + 1)) & Integer_To_String(Val(Cantidad.Text)))
...
Select Case Index
    Case 0
        ...
        Select Case NPCInventory(List1(0).ListIndex + 1).ObjType
            Case 2
                Label1(3).Caption = Locale_GUI_Frase(175) & ": " & NPCInventory(List1(0).ListIndex + 1).MinHIT & "/" & NPCInventory(List1(0).ListIndex + 1).MaxHIT & ". " & NPCInventory(List1(0).ListIndex + 1).ExtraStr
                Label1(3).Visible = True
            Case 3
                Label1(3).Caption = Locale_GUI_Frase(176) & ": " & NPCInventory(List1(0).ListIndex + 1).Def & ". " & NPCInventory(List1(0).ListIndex + 1).ExtraStr
                Label1(3).Visible = True
            Case Else
                If LenB(NPCInventory(List1(0).ListIndex + 1).ExtraStr) > 0 Then
                    Label1(3).Caption = NPCInventory(List1(0).ListIndex + 1).ExtraStr
                    Label1(3).Visible = True
                Else
        ...
        If NPCInventory(List1(0).ListIndex + 1).GrhIndex <> 0 Then
            Call frmMain.Engine.Grh_Render_To_Hdc(NPCInventory(List1(0).ListIndex + 1).GrhIndex, Picture1.hDC, 0, 0)
        Else
    ...
    Case 1
        ...
        Select Case UserInventory(List1(1).ListIndex + 1).ObjType
            Case 2
                Label1(3).Caption = Locale_GUI_Frase(175) & ": " & UserInventory(List1(1).ListIndex + 1).MinHIT & "/" & UserInventory(List1(1).ListIndex + 1).MaxHIT & ". " & UserInventory(List1(1).ListIndex + 1).ExtraStr
                Label1(3).Visible = True
            Case 3
                Label1(3).Caption = Locale_GUI_Frase(176) & ": " & UserInventory(List1(1).ListIndex + 1).Def & ". " & UserInventory(List1(1).ListIndex + 1).ExtraStr
                Label1(3).Visible = True
            Case Else
                If LenB(UserInventory(List1(1).ListIndex + 1).ExtraStr) > 0 Then
                    Label1(3).Caption = UserInventory(List1(1).ListIndex + 1).ExtraStr
                    Label1(3).Visible = True
                Else
                    Label1(3).Visible = False
                End If
        ...
        If UserInventory(List1(1).ListIndex + 1).GrhIndex <> 0 Then
            Call frmMain.Engine.Grh_Render_To_Hdc(UserInventory(List1(1).ListIndex + 1).GrhIndex, Picture1.hDC, 0, 0)
        Else
            Picture1.Picture = Nothing
        End If
End Select
...
Select Case Index
    Case 0
        cmdMasMenos(Index).Picture = General_Load_Picture_From_Resource_Ex("menos-down")
        cmdMasMenos(Index).Tag = "1"
        Cantidad.Text = str((Val(Cantidad.Text) - 1))
        m_Increment = -1
    Case 1
        cmdMasMenos(Index).Picture = General_Load_Picture_From_Resource_Ex("mas-down")
        cmdMasMenos(Index).Tag = "1"
        m_Increment = 1
End Select
...
Select Case Index
    Case 0
        If cmdMasMenos(Index).Tag = "0" Then
            cmdMasMenos(Index).Picture = General_Load_Picture_From_Resource_Ex("menos-over")
            cmdMasMenos(Index).Tag = "1"
        End If
    Case 1
        If cmdMasMenos(Index).Tag = "0" Then
            cmdMasMenos(Index).Picture = General_Load_Picture_From_Resource_Ex("mas-over")
            cmdMasMenos(Index).Tag = "1"
        End If
End Select
...
Public Sub Refresh_NPC_Inventory()
