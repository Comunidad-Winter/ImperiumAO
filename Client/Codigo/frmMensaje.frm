...
cmdAceptar.Picture = General_Load_Picture_From_Resource_Ex("infoaceptardown")
cmdAceptar.Tag = "1"
...
If cmdAceptar.Tag = "0" Then
    cmdAceptar.Picture = General_Load_Picture_From_Resource_Ex("infoaceptarover")
    cmdAceptar.Tag = "1"
End If
...
Me.Picture = General_Load_Picture_From_Resource_Ex("info")
...
If CurrentUser.sndPrivateTo <> vbNullString Then
    ...
    If frmMain.SendTxt.Visible Then frmMain.SendTxt.SetFocus
Else
    Call MensajeAdvertencia(Locale_GUI_Frase(258))
End If
