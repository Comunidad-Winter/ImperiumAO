...
cmdAceptar.Picture = General_Load_Picture_From_Resource("infoaceptardown")
cmdAceptar.Tag = "1"
...
If cmdAceptar.Tag = "0" Then
    cmdAceptar.Picture = General_Load_Picture_From_Resource("infoaceptarover")
    cmdAceptar.Tag = "1"
End If
...
Me.Picture = General_Load_Picture_From_Resource("info")
