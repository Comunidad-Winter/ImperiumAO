...
Command2.Picture = General_Load_Picture_From_Resource("salir-down")
Command2.Tag = "1"
End Sub
...
If Command2.Tag = "0" Then
    Command2.Picture = General_Load_Picture_From_Resource("salir-over")
    Command2.Tag = "1"
End If
...
Me.Picture = General_Load_Picture_From_Resource("comercio")
m_Number = 1
m_Interval = 30
End Sub
...
If Index = 0 Then
    Image1(Index).Picture = General_Load_Picture_From_Resource("comprar-down")
    Image1(Index).Tag = "1"
ElseIf Index = 1 Then
    Image1(Index).Picture = General_Load_Picture_From_Resource("vender-down")
    Image1(Index).Tag = "1"
End If
...
If Index = 0 Then
    If Image1(Index).Tag = "0" Then
        Image1(Index).Picture = General_Load_Picture_From_Resource("comprar-over")
        Image1(Index).Tag = "1"
    End If
ElseIf Index = 1 Then
    If Image1(Index).Tag = "0" Then
        Image1(Index).Picture = General_Load_Picture_From_Resource("vender-over")
        Image1(Index).Tag = "1"
    End If
End If
...
Select Case Index
    Case 0
        cmdMasMenos(Index).Picture = General_Load_Picture_From_Resource("menos-down")
        cmdMasMenos(Index).Tag = "1"
        Cantidad.Text = str((Val(Cantidad.Text) - 1))
        m_Increment = -1
    Case 1
        cmdMasMenos(Index).Picture = General_Load_Picture_From_Resource("mas-down")
        cmdMasMenos(Index).Tag = "1"
        m_Increment = 1
End Select
...
Select Case Index
    Case 0
        If cmdMasMenos(Index).Tag = "0" Then
            cmdMasMenos(Index).Picture = General_Load_Picture_From_Resource("menos-over")
            cmdMasMenos(Index).Tag = "1"
        End If
    Case 1
        If cmdMasMenos(Index).Tag = "0" Then
            cmdMasMenos(Index).Picture = General_Load_Picture_From_Resource("mas-over")
            cmdMasMenos(Index).Tag = "1"
        End If
End Select
