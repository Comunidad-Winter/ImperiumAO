...
If lstArmas.Visible Then
    Call ClientTCP.Send_Data(Herrero_Build, ArmasHerrero(lstArmas.ListIndex) & "," & txtCantidad.Text)
Else
    Call ClientTCP.Send_Data(Herrero_Build, ArmadurasHerrero(lstArmaduras.ListIndex) & "," & txtCantidad.Text)
End If
