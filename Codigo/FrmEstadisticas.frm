...
cmdClose.Picture = General_Load_Picture_From_Resource("cerrar-est-down")
End Sub
...
If cmdClose.Tag = "0" Then
    cmdClose.Tag = "1"
    cmdClose.Picture = General_Load_Picture_From_Resource("cerrar-est-over")
End If
...
Call Sound.Sound_Play(SND_CLICK)
cmdGuardar.Picture = General_Load_Picture_From_Resource("guardar-down")
End Sub
...
If cmdGuardar.Tag = "0" Then
    cmdGuardar.Tag = "1"
    cmdGuardar.Picture = General_Load_Picture_From_Resource("guardar-over")
End If
...
Private Sub Fami_Click(Index As Integer)

End Sub

Private Sub Form_Load()
Me.Picture = General_Load_Picture_From_Resource("stats")
End Sub
...
If CurrentUser.UserReputacion.Promedio < 0 Then
    imgEstado.Picture = General_Load_Picture_From_Resource("criminal")
ElseIf CurrentUser.UserReputacion.Promedio > 0 Then
    imgEstado.Picture = Nothing
Else
    imgEstado.Picture = General_Load_Picture_From_Resource("neutral")
End If
