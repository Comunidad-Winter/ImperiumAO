...
Select Case Index
    Case 0 'Crear
        imgAccion(0).Picture = General_Load_Picture_From_Resource("creardown")
        imgAccion(0).Tag = "0"
    Case 1 'Volver
        imgAccion(1).Picture = General_Load_Picture_From_Resource("volverdown")
        imgAccion(1).Tag = "0"
End Select
...
Select Case Index
    Case 0 'Crear personaje
        If imgAccion(0).Tag = "1" Then
            imgAccion(0).Picture = General_Load_Picture_From_Resource("crearover")
            imgAccion(0).Tag = "0"
    ...
    Case 1 'Volver
        If imgAccion(1).Tag = "1" Then
            imgAccion(1).Picture = General_Load_Picture_From_Resource("volverover")
            imgAccion(1).Tag = "0"
            Call Sound.Sound_Play(SND_OVER)
        End If
End Select
...
Me.Picture = General_Load_Picture_From_Resource("cp-interface")
...
Image1.Picture = General_Load_Picture_From_Resource(LCase$(lstProfesion.Text) & "")
Call ResetAtributos
...
Else
    ...
    imgNoDisp.Picture = General_Load_Picture_From_Resource("mascotanodisp")
