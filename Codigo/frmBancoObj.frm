...
Me.Picture = General_Load_Picture_From_Resource("boveda")
m_Number = 1
m_Interval = 30
End Sub
...
If Index = 0 Then
    Image1(Index).Picture = General_Load_Picture_From_Resource("retirar-down")
    Image1(Index).Tag = "1"
ElseIf Index = 1 Then
    Image1(Index).Picture = General_Load_Picture_From_Resource("depositar-down")
    Image1(Index).Tag = "1"
End If
...
If Index = 0 Then
    If Image1(Index).Tag = "0" Then
        Image1(Index).Picture = General_Load_Picture_From_Resource("retirar-over")
        Image1(Index).Tag = "1"
    End If
ElseIf Index = 1 Then
    If Image1(Index).Tag = "0" Then
        Image1(Index).Picture = General_Load_Picture_From_Resource("depositar-over")
        Image1(Index).Tag = "1"
    End If
End If
