...
Me.Picture = General_Load_Picture_From_Resource("conectar")
...
Select Case Index
    Case 0 'Crear personaje
        imgAccion(0).Picture = General_Load_Picture_From_Resource("botcreardown")
        imgAccion(0).Tag = "0"
    Case 1 'Conectar
        imgAccion(1).Picture = General_Load_Picture_From_Resource("botconectardown")
        imgAccion(1).Tag = "0"
    Case 2 'Recuperar
        imgAccion(2).Picture = General_Load_Picture_From_Resource("botrecuperardown")
        imgAccion(2).Tag = "0"
    Case 3 'Borrar
        imgAccion(3).Picture = General_Load_Picture_From_Resource("botborrardown")
        imgAccion(3).Tag = "0"
    Case 4 'Opciones
        imgAccion(4).Picture = General_Load_Picture_From_Resource("botopcionesdown")
        imgAccion(4).Tag = "0"
End Select
...
Select Case Index
    Case 0 'Crear personaje
        If imgAccion(0).Tag = "1" Then
            imgAccion(0).Picture = General_Load_Picture_From_Resource("botcrearover")
            imgAccion(0).Tag = "0"
    ...
    Case 1 'Conectar
        If imgAccion(1).Tag = "1" Then
            imgAccion(1).Picture = General_Load_Picture_From_Resource("botconectarover")
            imgAccion(1).Tag = "0"
            Call Sound.Sound_Play(SND_OVER)
        End If
    Case 2 'Recuperar
        If imgAccion(2).Tag = "1" Then
            imgAccion(2).Picture = General_Load_Picture_From_Resource("botrecuperarover")
            imgAccion(2).Tag = "0"
            Call Sound.Sound_Play(SND_OVER)
        End If
    Case 3 'Borrar
        If imgAccion(3).Tag = "1" Then
            imgAccion(3).Picture = General_Load_Picture_From_Resource("botborrarover")
            imgAccion(3).Tag = "0"
            Call Sound.Sound_Play(SND_OVER)
        End If
    Case 4 'Opciones
        If imgAccion(4).Tag = "1" Then
            imgAccion(4).Picture = General_Load_Picture_From_Resource("botopcionesover")
            imgAccion(4).Tag = "0"
            Call Sound.Sound_Play(SND_OVER)
        End If
End Select
