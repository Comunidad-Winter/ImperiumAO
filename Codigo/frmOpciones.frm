...
If chkMidi.Value = 1 Then
    ...
    If CurrentUser.Logged Then
        Call ClientTCP.Send_Data(Midi_Request)
    Else
...
Select Case Index
    ...
    Case 9
        ...
        If CurrentUser.Logged Then Call ClientTCP.Send_Data(Global_Option, MensajesGlobales)
...
For i = 0 To lstIgnore.ListCount
    If UCase$(lstIgnore.List(i)) = Nick Then
        If CurrentUser.Logged Then
            Call AddtoRichTextBox(frmMain.RecTxt, Nick & " ya había sido ignorado.", 0, 0, 0, 0, 0, 0, 8)
        Else
...
If CurrentUser.Logged Then Call AddtoRichTextBox(frmMain.RecTxt, Nick & " ha sido ignorado.", 0, 0, 0, 0, 0, 0, 8)
