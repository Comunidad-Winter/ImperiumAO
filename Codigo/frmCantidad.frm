...
Me.Picture = General_Load_Picture_From_Resource("cantidad")
...
imgCerrar.Picture = General_Load_Picture_From_Resource("cerrarcantdown")
End Sub
...
If imgCerrar.Tag = "0" Then
    imgCerrar.Picture = General_Load_Picture_From_Resource("cerrarcantover")
    imgCerrar.Tag = "1"
End If
...
imgAceptar.Picture = General_Load_Picture_From_Resource("dejardown")
End Sub
...
If imgAceptar.Tag = "0" Then
    imgAceptar.Picture = General_Load_Picture_From_Resource("dejarover")
    imgAceptar.Tag = "1"
End If
...
imgTodo.Picture = General_Load_Picture_From_Resource("dejartododown")
End Sub

Private Sub imgTodo_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)

If imgTodo.Tag = "0" Then
    imgTodo.Picture = General_Load_Picture_From_Resource("dejartodoover")
    imgTodo.Tag = "1"
End If
...
If ItemElegido <> FLAGORO Then
    Call ClientTCP.Send_Data(Drop_Item, ItemElegido & "," & UserInventory(ItemElegido).Amount)
Else
    Call ClientTCP.Send_Data(Drop_Item, ItemElegido & "," & IIf(CurrentUser.UserGLD <= 100000, CurrentUser.UserGLD, 100000))
End If
...
Me.Visible = False
Call ClientTCP.Send_Data(Drop_Item, ItemElegido & "," & txtCant.Text)
txtCant.Text = "0"
