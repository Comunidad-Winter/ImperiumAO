...
Call ClientTCP.Send_Data(Guild_Declare_Allie, Right(nombre, Len(nombre) - 7))
End Sub
...
Call ClientTCP.Send_Data(Guild_Declare_War, Right(nombre.Caption, Len(nombre.Caption) - 7))
End Sub
