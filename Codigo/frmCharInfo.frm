...
Call ClientTCP.Send_Data(Guild_Accept_Member, Right(Nombre.Caption, Len(Nombre.Caption) - 7))
...
Raza.Caption = "Raza:" & RazaToString(String_To_Byte(Argumentos, 1))
Clase.Caption = "Clase:" & CharClaseValueToString(String_To_Byte(Argumentos, 2))
Genero.Caption = "Genero:" & IIf(String_To_Byte(Argumentos, 3) = Masculino, "Masculino", "Femenino")
Nivel.Caption = "Nivel:" & String_To_Integer(Argumentos, 4)
Oro.Caption = "Oro:" & String_To_Long(Argumentos, 6)
Banco.Caption = "Banco:" & String_To_Long(Argumentos, 10)
...
Solicitudes.Caption = "Solicitudes para ingresar a clanes:" & String_To_Long(Argumentos, 19)
solicitudesRechazadas.Caption = "Solicitudes rechazadas:" & String_To_Long(Argumentos, 23)

If tempByte = 1 Then
    fundo.Caption = "Fundo el clan: " & General_Field_Read(2, tempStr, ",")
Else
    fundo.Caption = "Fundo el clan: Ninguno"
End If

lider.Caption = "Veces fue lider de clan:" & String_To_Long(Argumentos, 27)
integro.Caption = "Clanes que integro:" & String_To_Long(Argumentos, 31)
...
Else
    tempByte = String_To_Byte(Argumentos, 36)
    If Y = 1 Then
...
Ciudadanos.Caption = "Ciudadanos asesinados:" & String_To_Long(Argumentos, 37)
criminales.Caption = "Criminales asesinados:" & String_To_Long(Argumentos, 41)

Nombre.Caption = "Nombre:" & General_Field_Read(1, tempStr, ",")
...
Call ClientTCP.Send_Data(Guild_Send_Petition, Right(Nombre, Len(Nombre) - 7))
End Sub

Private Sub Echar_Click()
Call ClientTCP.Send_Data(Guild_Remove_Member, Right(Nombre, Len(Nombre) - 7))
frmmiembros = False
frmsolicitudes = False
Unload frmGuildLeader
Call ClientTCP.Send_Data(Guild_Info_Request)
...
Call ClientTCP.Send_Data(Guild_Deny_Member, Right(Nombre, Len(Nombre) - 7))
frmmiembros = False
frmsolicitudes = False
Unload frmGuildLeader
Call ClientTCP.Send_Data(Guild_Info_Request)
